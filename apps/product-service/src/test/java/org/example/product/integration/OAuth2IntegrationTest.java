...
/**
 * Integration tests for OAuth2 security flow.
 * Tests inbound JWT validation and verifies the full request/response cycle.
 */
...
class OAuth2IntegrationTest {
    ...
    void shouldAuthenticateAndReturnProduct() {
        ...
        webTestClient.get()
            ...
            .jsonPath("$.description").isEqualTo("Test Product Description")
    ...
    void shouldRejectWrongScope() {
        String wrongScopeToken = TestJwtBuilder.builder()
            .scope("other:read")
            .build();
    ...
    void shouldHandleMultipleScopes() {
        String multiScopeToken = TestJwtBuilder.builder()
            .scopes("product:read", "product:write", "admin")
            .build();
