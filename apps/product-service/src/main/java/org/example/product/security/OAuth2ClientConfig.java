...
/**
 * Configures OAuth2 client credentials for downstream service authentication. Uses in-memory token
 * caching - tokens are cached until expiration, then automatically refreshed.
 *
 * <p>Only active when app.security.oauth2-client.enabled=true (default: true). Disabled in tests
 * via application.yml setting.
 */
@Configuration
