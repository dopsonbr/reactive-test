...
class WebClientLoggingFilterTest {
  ...
  void shouldLogRequestAndResponseWithMetadata() {
    ...
    ClientRequest request =
        ClientRequest.create(HttpMethod.GET, URI.create("http://localhost:8081/test")).build();
  ...
  void shouldHandleNullPayloadInRequest() {
    ...
    ClientRequest request =
        ClientRequest.create(HttpMethod.POST, URI.create("http://localhost:8081/price")).build();
