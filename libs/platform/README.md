...
./gradlew :libs:platform:platform-bom:build
./gradlew :libs:platform:platform-logging:build
./gradlew :libs:platform:platform-resilience:build
./gradlew :libs:platform:platform-cache:build
./gradlew :libs:platform:platform-error:build
./gradlew :libs:platform:platform-webflux:build
./gradlew :libs:platform:platform-security:build
./gradlew :libs:platform:platform-test:build
```

## Creating a New Platform Library

1. Create directory: `libs/platform/platform-new/`
