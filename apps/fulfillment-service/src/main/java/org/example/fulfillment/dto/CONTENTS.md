...
| File | Description |
|------|-------------|
| `AddressValidationRequest.java` | Request for address validation with street, city, state, zip |
| `AddressValidationResponse.java` | Response with validation result and standardized address |
| `FulfillmentCostRequest.java` | Request for fulfillment cost calculation |
...
| `ShippingOptionsResponse.java` | Response containing list of available shipping options |
