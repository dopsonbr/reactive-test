...
public class PostgresCustomerRepository implements CustomerRepository {
    ...
    public Mono<Customer> findByEmail(int storeNumber, String email) {
        return entityRepository
                .findByStoreNumberAndEmail(storeNumber, email)
    ...
    public Mono<Customer> findByPhone(int storeNumber, String phone) {
        return entityRepository
                .findByStoreNumberAndPhone(storeNumber, phone)
                .flatMap(this::toDomain);
    }
    ...
    public Flux<Customer> search(int storeNumber, String searchTerm) {
        return entityRepository
                .searchByIdEmailOrPhone(storeNumber, searchTerm)
                .flatMap(this::toDomain);
    }
        ...
        return Mono.fromCallable(
                () -> {
                    List<Address> addresses =
                            deserialize(entity.addressesJson(), ADDRESS_LIST_TYPE);
                    WalletReference wallet =
                            deserialize(entity.walletJson(), WalletReference.class);
                    CommunicationPreferences commPrefs =
                            deserialize(
                                    entity.communicationPrefsJson(),
                ...
                () -> {
                    ...
                    String parentCustomerId =
                            customer.b2bInfo() != null
                                    ? customer.b2bInfo().parentCustomerId()
                                    : null;
