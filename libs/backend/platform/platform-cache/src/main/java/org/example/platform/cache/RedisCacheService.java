...
/**
 * Redis implementation of ReactiveCacheService. Fails silently on Redis errors to avoid cascading
 * failures.
 *
 * <p>This bean is auto-configured by {@link RedisCacheAutoConfiguration} when Redis is on the
 * classpath.
 */
