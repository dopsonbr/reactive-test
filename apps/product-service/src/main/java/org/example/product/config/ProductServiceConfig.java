...
/**
 * Configures WebClient beans for downstream service calls. Each WebClient includes: - OAuth2 filter
 * for automatic client credentials token injection (when enabled) - Logging filter for structured
