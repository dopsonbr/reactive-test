 ...
 *
 * <p>This entity maps to the 'orders' table and uses JSONB columns for denormalized data. Order
 * service shares this table with checkout-service (read/update only).
 *
